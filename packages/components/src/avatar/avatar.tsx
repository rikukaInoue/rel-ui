...
const fallbackStyle = css({ bg: "bg.action.primary", color: "text.inverse" });
...
export function Avatar({ src, name, size = "md", className }: AvatarProps) {
  return (
    <span className={cx(baseStyle, sizeStyles[size], !src && fallbackStyle, className)} aria-label={name}>
